<template>
  <div class="floating-panel">
    <div class="panel-header"><h3>工单中心</h3><button class="panel-close-btn" @click="$router.push('/overview')">✕</button></div>
    <div class="panel-body"><WorkOrderPanel :orders="orders" /></div>
  </div>
</template>
